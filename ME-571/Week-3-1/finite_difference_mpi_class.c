...
int main(int argc, char* argv[])
{
  ...
  printf("Problem size N = %ld, N_loc = %ld,  nproc = %d, irank=%d, Error = %e, Elapsed time: initialization = %e s, computation = %e s\n",N,N_loc,nproc,irank,error,elapsed_time_init, elapsed_time_comput);
